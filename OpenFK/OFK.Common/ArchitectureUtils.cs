...
{
    // The following code has been taken from https://stackoverflow.com/questions/1001404/check-if-unmanaged-dll-is-32-bit-or-64-bit
    ...
    static class ArchitectureUtils
    {
